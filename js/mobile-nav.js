document.addEventListener('DOMContentLoaded', () => {
   ...
   */
  const elfsightWidgets = document.querySelectorAll(
    '[class*="elfsight-app-"]'
  );
  ...
  elfsightScript.addEventListener('error', () => {
    ...
    counterSection.classList.add('has-load-error');

    const counterWidget = counterSection.querySelector(
